package com.example.webrtcdemo2.WebRTCLib;

import android.annotation.SuppressLint;
import android.util.Log;

import com.example.webrtcdemo2.Activity.VideoCallActivity;
import com.example.webrtcdemo2.WebFields.WebFields;
...
public class SignallingClient {
    ...
    public void init(SignalingInterface signalingInterface) {
        ...
        try {
            ...
            socket = IO.socket(WebFields.BASE_URL_SOCKET_NUMBER);
            socket.connect();
    ...
    public void emitMessage(SessionDescription message) {
        try {
            ...
            Log.e("emitMessage", obj.toString());
